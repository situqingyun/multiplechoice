...
from model.modeling_nezha import NeZhaForMultipleChoice, NeZhaForMultipleChoiceWithMatch, NeZhaForMultipleChoiceWithDUMA, NeZhaForMultipleChoiceWithDUMAAndDCMN
...
from model.modeling_bert import BertForMultipleChoiceWithMatch, BertForMultipleChoiceWithDUMA, BertForMultipleChoiceWithDUMAAndDCMN
...
MODEL_CLASSES = {
    'nezha': (NeZhaConfig, NeZhaForMultipleChoiceWithDUMAAndDCMN, BertTokenizer),
    'bert': (BertConfig, BertForMultipleChoiceWithDUMAAndDCMN, BertTokenizer),
