...
from model.modeling_nezha import NeZhaForMultipleChoice, NeZhaForMultipleChoiceWithFocalLoss
...
from model.modeling_bert import BertForMultipleChoiceWithFocalLoss
...
# ]
MODEL_CLASSES = {
    'nezha': (NeZhaConfig, NeZhaForMultipleChoiceWithFocalLoss, BertTokenizer),
    'bert': (BertConfig, BertForMultipleChoiceWithFocalLoss, BertTokenizer),
